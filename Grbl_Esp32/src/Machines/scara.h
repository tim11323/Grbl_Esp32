...
#endif
#define CONTROL_SW_DEBOUNCE_PERIOD 10 // really long debounce
...
#define MACRO_BUTTON_0_PIN      GPIO_NUM_14
#define MACRO_BUTTON_1_PIN      GPIO_NUM_27
